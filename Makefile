...
#    Updated: 2024/12/22 20:39:30 by ayhamdou         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = utils/ft_split.c utils/ft_strcmp.c utils/ft_strdup.c utils/ft_strlen.c utils/ft_substr.c\
		...
		utils/ft_putstr_fd.c utils/ft_itoa.c utils/ft_strcpy.c utils/ft_strcat.c utils/ft_strndup.c\
		utils/ft_atol.c\
		...
		execution/builtins/the_pwd.c execution/builtins/the_unset.c execution/builtins/the_export_helper_0.c\
		execution/builtins/the_export_helper_1.c execution/exec.c execution/exec_multiple_cmd.c\
		execution/exec_command_helper.c\
